    ...
    return (
        <>
            <div className={styles.coverImage}>
                <Image className={styles.coverImageGraves} src={graves} alt='Groblje Horora Naslovna slika, silueta grobova u prvom planu' style={{position: "absolute"}}/>
                <Image priority={true} src={coverImage} alt='Groblje Horora Naslovna slika, pozadina'/>
                <div className={styles.coverImageTrees}>
                    <Image className={styles.leftTree} width={428} height={800} src={'/images/groblje-horora-cover-left-tree.svg'} alt='Groblje Horora Naslovna slika, silueta drveta s lijeve strane'/>
                    ...
                    <Image className={styles.rightTree} width={428} height={800} src={'/images/groblje-horora-cover-left-tree.svg'} alt='Groblje Horora Naslovna slika, silueta drveta s desne strane'/>
                </div>
            </div>
        </>
    )
